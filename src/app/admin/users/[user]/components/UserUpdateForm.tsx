    ...
    try {
      ...
      if (res) {
        toast({
          ...
          description: 'User profile has been updated sucessfully',
        });
        closedrawer();
      }
    } catch (error) {
      ...
      <div className="">
        ...
        >
          ...
          <div className="">
            <Label>Role</Label>
            <select
              className="w-full border rounded-md p-1 border-green_custom focus:border-orange-400 focus:outline-none"
